...
class SysLoginLogServiceImplTest extends BaseDbUnitTest {
    ...
    @Test
    void testListPage() {
        SysLoginLogDO loginLog1 = randomPojo(SysLoginLogDO.class)
                .setId(null)
        ...
        SysLoginLogDO loginLog2 = randomPojo(SysLoginLogDO.class)
                .setId(null)
        ...
        Page<SysLoginLogDO> result = loginLogService.listPage(query);
    ...
    @Test
    void testGetById() {
        SysLoginLogDO loginLog = randomPojo(SysLoginLogDO.class)
                .setId(null)
                .setUsername("admin_get_login_log");
        loginLogMapper.insert(loginLog);

        SysLoginLogDO result = loginLogService.getById(loginLog.getId());
