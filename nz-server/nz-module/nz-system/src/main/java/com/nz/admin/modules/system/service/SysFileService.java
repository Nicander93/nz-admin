...
public interface SysFileService {
    ...
    Page<SysFileDO> listPage(SysFileQuery query);
    ...
    public static class BatchUploadResult {
        private List<SysFileDO> successFiles = new ArrayList<>();
        private List<FailedFile> failedFiles = new ArrayList<>();
        private Integer totalCount = 0;
        private Integer successCount = 0;
        private Integer failCount = 0;

        public List<SysFileDO> getSuccessFiles() { return successFiles; }
        public void setSuccessFiles(List<SysFileDO> successFiles) { this.successFiles = successFiles; }
