...
public interface FileService {
    ...
    Page<FileDO> listPage(FileQuery query);

    String getStorageType();

    FileDO upload(MultipartFile file, Long uploaderId) throws IOException;
    ...
    public static class BatchUploadResult {
        private List<FileDO> successFiles = new ArrayList<>();
        private List<FailedFile> failedFiles = new ArrayList<>();
        private Integer totalCount = 0;
        private Integer successCount = 0;
        private Integer failCount = 0;

        public List<FileDO> getSuccessFiles() { return successFiles; }
        public void setSuccessFiles(List<FileDO> successFiles) { this.successFiles = successFiles; }
