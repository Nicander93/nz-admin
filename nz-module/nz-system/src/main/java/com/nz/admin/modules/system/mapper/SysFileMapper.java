...
public interface SysFileMapper extends BaseMapper<SysFile> {
    ...
    default Page<SysFile> selectPageByCondition(Page<SysFile> page, SysFileQuery query) {
        ...
        wrapper.like(StrUtil.isNotBlank(query.getOriginalName()), SysFile::getOriginalName, query.getOriginalName())
               .eq(StrUtil.isNotBlank(query.getFileExt()), SysFile::getFileExt, query.getFileExt())
