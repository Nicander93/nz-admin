<template>
  <div>
    ...
    <div class="mb-4">
      <el-button v-permission="'system:role:add'" type="primary" @click="form.toAdd">新增</el-button>
    </div>
    ...
    <el-table :data="table.data" v-loading="table.loading" border>
      ...
      <el-table-column label="操作" width="240" fixed="right">
        <template #default="{ row }">
          <el-button v-permission="'system:role:edit'" link type="primary" @click="form.toEdit(row)">编辑</el-button>
